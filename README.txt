...
a persistence unit "EvaluacionWSVeletangaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSVeletanga\pom.xml":
...
artifact ("EvaluacionWSVeletanga.war") is already built. You can build
